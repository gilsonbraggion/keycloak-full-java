package com.gilsonbraggion.auth.config;
...
import com.gilsonbraggion.auth.config.KeycloakServerProperties.AdminUser;
...
public class EmbeddedKeycloakApplication extends KeycloakApplication {
    ...
    private void createGilsonBraggionRealm() {
        KeycloakSession session = getSessionFactory().create();
